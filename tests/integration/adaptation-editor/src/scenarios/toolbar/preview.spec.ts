...
test.describe(`@toolbar @preview-scale @cpe @adp`, () => {
    ...
    test('1. Automatic zoom level adjustment', {}, async ({ page, ui5Version, previewFrame }) => {
    ...
    test('2. Increase and decrease zoom level', {}, async ({ page, ui5Version, previewFrame }) => {
        // wait for frame to be loaded
        const editor = new AdaptationEditorShell(page, ui5Version);
        await editor.reloadCompleted();
        const lr = new ListReport(previewFrame);
    ...
    test('3. Fit mode', {}, async ({ page, ui5Version, previewFrame }) => {
        // wait for frame to be loaded
        const editor = new AdaptationEditorShell(page, ui5Version);
        await editor.reloadCompleted();
        const lr = new ListReport(previewFrame);
