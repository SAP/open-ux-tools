...
| Scope | Result |
| --- | ---: |
| `@sap-ux/mockserver-data-generator` | 28 suites and 243 tests passed on both Node 22.22.3 and Node 24.20.0; package build and zero-error lint passed on both |
...
| current source package archive | 94,953 / 5,242,880 bytes, pass; archive SHA-256 `443d35d67cea683520a596575dabab09344bf9e1d3cdfa2ccf5cda885386e7dd` |
...
| current clean dev kit | 566,486 bytes; fingerprint `64fbf17261ff5ade91004edc709f6cac450a2931013501a946fe701200fabad9`; SHA-256 `049927d74b1b596aed69afe8ec245dd0d9c98683e5665ff1bf0691015d2a3d9e`; two builds were byte-identical |
| current packed application canaries | The exact current archive passed V2, V4, and CDS on Node 22.22.3: standard paths served rows with `providerExecuted: false`; flagged paths verified both learned components, ran the provider, and served rows; V4 and CDS installer restores passed, while the disposable V2 copy was removed after verification |
