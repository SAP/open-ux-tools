...
| Realism | external | the exact package candidate now has a blinded, randomized 311-record packet covering six domains and EDMX V2/V4/CSN; 300 scalar fields and 11 coherence assertions pass the executable local gate and byte-identical replay; its SFT gate is 100% parse and 96.54% accepted-slot fill; evidence fingerprint `42922a81940f0dcc6fdacdd7648f6d5686238fa65d47623dca89221cc1d82cd7` is bound to package commit `04390772f75852440444a9ec076ee380e61aeaaf` | Two independent, lineage-bound provider reviews and at least 80% overall plus every domain/format |
...
| development-kit integration tests | The final local run passed 11 suites and 124 tests on Node 22.22.2, including the explicit evaluation-provider activation regression. Earlier 123-test runs passed on Node 22.22.2 and Node 24.20.0 |
