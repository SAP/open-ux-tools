...
| Scope | Result |
| --- | ---: |
| `@sap-ux/mockserver-data-generator` | 23 suites, 199 tests passed; 85.27% statement coverage; production return types, unsafe assignments, default paths, consistent returns, and non-null assertions enforced by lint |
