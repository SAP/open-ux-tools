...
a row that echoes the instructions. The repetition penalty applies to value tokens only. When the model or the relevance check is unavailable, generation keeps deterministic values with a
