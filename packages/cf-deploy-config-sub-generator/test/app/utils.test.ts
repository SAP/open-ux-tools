...
import { DESTINATION_CHOICE_DIRECT_SERVICE_BINDING, DESTINATION_CHOICE_NONE, DEFAULT_MTA_DESTINATION } from '../../src/utils/index.js';
...
describe('test utils', () => {
    ...
    describe('getCFChoices - CAP project', () => {
        ...
        it('always includes default option for CAP project even when no mta destinations', async () => {
            ...
            const choices = await getCFChoices({ projectRoot: '/project', isAbapDirectServiceBinding: false, isCap: true, cfDestination: '' });
