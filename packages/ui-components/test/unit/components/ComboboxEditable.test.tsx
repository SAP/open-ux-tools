...
import { ComboBoxEditable } from '../../../src/components';
...
describe('<ComboBoxEditable />', () => {
    const selectors = {
        root: '.editable-combobox',
        dropdownExpandBtn: '.ms-ComboBox .ms-ComboBox-CaretDown-button',
        dropdownMenuItem: '.ms-ComboBox-option',
        dropdownMenuEditableItem: '.ms-ComboBox-option .editable-item',
        dropdownMenuEditableItemInput: '.ms-ComboBox-option .editable-item input',
        callout: '.ms-ComboBox-callout',
    ...
    describe('Single edit', () => {
        ...
        test('Select edited item by click', () => {
            ...
            render(<ComboBoxEditable options={data} onChange={onChange} />);
            toggleDropdown();
    ...
    describe('Multi edit', () => {
        test('Render', () => {
            render(<ComboBoxEditable options={data} multiSelect={true} />);
            toggleDropdown();
            // Check all menu items
            expect(document.querySelectorAll(selectors.dropdownMenuItem).length).toEqual(2);
            // Check editable menu items
        ...
        test('Item edited', () => {
            const onChange = jest.fn();
            render(<ComboBoxEditable options={data} onChange={onChange} multiSelect={true} />);
            toggleDropdown();
            editItem('testEdit', 0);
            // Check all menu items
