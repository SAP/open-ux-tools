...
import { OptionKey, UISelectableOptionWithSubValues } from '../src/components/UIComboBox/DropdownEditable/types';

initIcons();

export default { title: 'Dropdowns/Dropdown SubMenu' };

const replacedFn = (key, value) => {
    return ['styles', 'options', 'submenuIconProps'].includes(key) ? undefined : value;
};

interface EditableDropdownExampleProps {
...
const EditableDropdownExample = (props: EditableDropdownExampleProps) => {
    const { options } = props;
...
export const generic = (): JSX.Element => <EditableDropdownExample options={data} />;
...
export const editableSingle = (): JSX.Element => <EditableDropdownExample options={editableSingleData} />;
...
export const editableMultiple = (): JSX.Element => <EditableDropdownExample options={editableMultipleData} />;
...
export const editableEntity = (): JSX.Element => <EditableDropdownExample options={editableEntityData} />;
...
export const editableLarge = (): JSX.Element => <EditableDropdownExample options={largeData} />;
