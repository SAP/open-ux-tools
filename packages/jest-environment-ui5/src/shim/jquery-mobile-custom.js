...
(function(root, doc, factory) {
  ...
  */
		...
		fake_onhashchange = (function() {
			...
			//SAP MODIFICATION - IE 6/7/8compat support was removed.
	...
	(function($, undefined) {
		...
		$.extend($.support, {
			...
			scrollTop:
				("pageXOffset" in window || "scrollTop" in document.documentElement || "scrollTop" in fakeBody[0]) && !webos && !operamini,
			...
			setup: function() {
				...
				function buttonTappedInEdgeBrowser(event) {
					...
					return (
						browser.edge &&
						browser.version >= 14 &&
						((eventTarget.tagName.toLowerCase() === "button" && eventTarget.contains(mouseDownTarget)) ||
							(mouseDownTarget.tagName.toLowerCase() === "button" && mouseDownTarget.contains(eventTarget)))
					);
				}
