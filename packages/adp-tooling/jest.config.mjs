...
export default {
    ...
    moduleNameMapper: {
        ...
        '^@ui5/task-adaptation$': resolve(__dirname, '../../node_modules/.pnpm/@ui5+task-adaptation@1.6.7_buffer@6.0.3_typescript@5.9.3/node_modules/@ui5/task-adaptation/dist/index.js')
    }
};
