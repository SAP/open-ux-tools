...
export async function getI18nBundles(
    ...
    result['sap.app'] = await getPropertiesI18nBundle(i18nPropertiesPaths['sap.app']);

    for (const key of Object.keys(i18nPropertiesPaths.models)) {
        result.models[key] = await getPropertiesI18nBundle(i18nPropertiesPaths.models[key].path);
    }
