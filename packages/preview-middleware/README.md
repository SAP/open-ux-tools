...
| `flp.useNewSandbox`     | `boolean`  | optional                                       | `true`           | Set to `false` to opt out of the new FLP Sandbox and use the classic sandbox even when the UI5 version qualifies (>= 1.150 or legacy-free)                                                                                                           |
