...
| `flp.apps`              | `array`    | optional                                       | `undefined`      | Additional local apps that are available in local SAP Fiori launchpad                                                                                                                                                                            |
...
| `flp.theme`             | `string`   | optional                                       | `(calculated)`   | Name of the UI5 Theme to be used (default is `sap_horizon` or the first entry in the sap.ui.supportedThemes list provided in the manifest.json if `sap_horizon` is not contained in that list).                                                  |
