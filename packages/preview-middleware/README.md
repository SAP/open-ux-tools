...
| `flp.intent.object`     | `string`   | optional                         | `app`            | Intent object                                                                                                                                                                                                                                    |
| `flp.intent.action`     | `string`   | optional                         | `preview`        | Intent action                                                                                                                                                                                                                                    |
...
| `adp.target`            |            | required for adaptation projects |                  | Required configuration defining the connected backend                                                                                                                                                                    |
...
| `intent.object`          | `string`   | optional         | `(calculated)` | Intent object, if it is not provided then it will be calculated based on the application id                 |
| `intent.action`          | `string`   | optional         | `preview`      | Intent action                                                                                               |
