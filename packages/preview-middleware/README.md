...
| `editors.cardGenerator.path` | `string`   | optional                              | `test/flpGeneratorSandbox.html`  (project type `application`) <br> `/flpGeneratorSandbox.html` (project type `component`) | The mount point of the local SAP Fiori launchpad which will be considered for card generation.                                                                                                                                                        |
