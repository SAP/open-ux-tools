...
| `flp.path`                   | `string`   | optional                                       | `/test/flp.html` (for UI5 project type `application`) <br> `/flp.html` (for UI5 project type `component`)                        | The mount point of the local SAP Fiori launchpad. In case no file is found at the given path, a virtual endpoint will be instantiated.                                                                                                                                                                                                                                        |
...
| `editors.cardGenerator.path` | `string`   | optional                                       | `test/flpGeneratorSandbox.html` (for UI5 project type `application`) <br> `/flpGeneratorSandbox.html` (project type `component`) | The mount point of the local SAP Fiori launchpad which will be considered for card generation.                                                                                                                                                                                                                                                                                |
...
| `path`            | `string`   | optional         | `(calculated)` | The mount point to be used for test suite. By default, `/test/opaTests.qunit.html` is used for `OPA5`, `/test/unitTests.qunit.html` is used for `QUnit`, and `/test/testsuite.qunit.html` is used for `Testsuite` for UI5 project type `application` and <br> `/opaTests.qunit.html` is used for `OPA5`, `/unitTests.qunit.html` is used for `QUnit`, and `/testsuite.qunit.html` is used for `Testsuite` for UI5 project type `component` |
