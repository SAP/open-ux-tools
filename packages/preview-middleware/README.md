...
| `flp.theme`             | `string`   | optional                                       | `(calculated)`   | Name of the UI5 Theme to be used (default is `sap_horizon` or the first entry in the sap.ui.supportedThemes list provided in the manifest.json in case sap_horizon is not contained in the list)                                               |
