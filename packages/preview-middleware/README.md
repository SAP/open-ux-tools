...
| `editors.cardGenerator` | ---    | optional                                       | `undefined`      | Configuration object to enable card generation for an application (Only CAP apps that are deployed to an S/4 FLP are supported).                                                                                                                                                  |
