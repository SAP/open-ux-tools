...
| `editors.cardGenerator` | ---    | optional                                       | `undefined`      | Configuration object to enable card generation for an application (Generated cards can only be used with an ABAP-based FLP, e.g. from S/4.).                                                                                                                                                  |
