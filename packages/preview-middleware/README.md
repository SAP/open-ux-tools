...
| `flp.libs`              | `boolean`  | optional                                       | `true` (for EDMX backends)      | Paths of used EDMX backend libraries not available in UI5 are fetched (This avoids loading libraries from the `/resources` path).                                                              |
