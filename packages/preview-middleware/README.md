...
| `editors.cardGenerator` | ---    | optional                                       | `undefined`      | Configuration object that enables card generation for an application. The generated cards can be used only when the application is deployed to an ABAP-based Fiori launchpad (for example, the SAP S/4HANA Fiori launchpad).                                                                                                                                                |
