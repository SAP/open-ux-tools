...
| `editors.cardGenerator` | ---    | optional                                       | `undefined`      | Configuration object that enables card generation for an application. Only CAP applications deployed to the SAP S/4HANA Fiori Launchpad are supported.                                                                                                                                                  |
