...
describe('utils', () => {
    ...
    describe('isReuseComponent', () => {
        ...
        it('should return false for ui5 minor version lower than 114', () => {
            expect(isReuseComponent(clickedControlId, { majorUi5Version:1, minorUi5Version:112, version: '1.112' })).toBe(false);
        });
        ...
        it('should return false when cannot find component with clicked control Id', () => {
            ...
            expect(isReuseComponent(clickedControlId, { majorUi5Version:1, minorUi5Version:118, version: '1.118' })).toBe(false);
        });
        ...
        it('should return true when type is component', () => {
            ...
            expect(isReuseComponent(clickedControlId, { majorUi5Version:1, minorUi5Version:118, version: '1.118' })).toBe(true);
        });
    });
});
