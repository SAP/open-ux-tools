...
describe('vaildateBindingModel', () => {
    ...
    test('should throw when invalid binding model string is provided', async () => {
        ...
        await expect(async () => await validateBindingModel(mockModifiedcontrol as unknown as UI5Element, '{}')).rejects.toThrow('Invalid binding string.');
    });
    ...
    test('should throw when invalid binding string for i18n model is provided', async () => {
        ...
        await expect(async () => await validateBindingModel(mockModifiedcontrol as unknown as UI5Element, '{ i18n }')).rejects.toThrow('Invalid binding string. Supported value pattern is {i18n>YOUR_KEY}');
    });
    ...
    test('should throw error when invalid binding model is provided', async () => {
        ...
        await expect(async () => await validateBindingModel(control as unknown as UI5Element, '{ i18n>test }')).rejects.toThrow('Invalid binding model.');
    });
});
