...
**Unit Tests:** ✅ 19 passing (add: 12, remove: 7)  
...
### **Test 3: Add System - All Flags (Skip Interactive)**
...
### **Test 14: Remove System - Force (No Confirmation)**
...
✅ **Verified:** This command was tested successfully in CLI.
...
```bash
cd /Users/I320242/Documents/SAPDevelop/open-ux-tools/packages/create
...
```bash
pnpm test -- test/unit/cli/add/system.test.ts
pnpm test -- test/unit/cli/remove/system.test.ts
```

**add system tests (12 passing):**
- ✅ should add a system with all flags provided (no prompting)
- ✅ should add a system with username and password
- ✅ should add a system without credentials
- ✅ should check connection when not using --skip-check
- ✅ should not save system when connection check fails and user declines
- ✅ should log error and exit when running in BAS
- ✅ should log error when write throws
- ✅ should log error for invalid --type value
- ✅ should log error for invalid --auth value
- ✅ should log error for invalid --connection-type value
- ✅ should log error for invalid URL
- ✅ should log error when system already exists

**remove system tests (7 passing):**
- ✅ should remove an existing system with --force (no confirmation)
- ✅ should prompt for confirmation when --force not provided
- ✅ should not remove system when user declines confirmation
- ✅ should log error when system not found
- ✅ should log error when delete returns false
- ✅ should log error and exit when running in BAS
- ✅ should log error when delete throws

### Manual CLI Test Results

All commands tested successfully on 2026-07-15:

**✅ Help Output** - All help text shows correctly with new flags  
**✅ Add System** - Works with full flags, partial flags, and --skip-check  
**✅ List System** - Shows systems in human-readable and JSON format, no credentials exposed  
**✅ Get System** - Retrieves specific system, credentials masked  
**✅ Update System** - Updates name and credentials, connection check works  
**✅ Remove System** - Removes with --force, prompts for confirmation without it  
**✅ Error Handling** - Invalid URL, duplicate system, non-existent system all handled correctly  
**✅ Security** - No passwords/tokens in any output format
