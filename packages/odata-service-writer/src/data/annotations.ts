...
import { t } from '../i18n';
import type { NamespaceAlias, EdmxAnnotationsInfo } from '../types';
 ...
 */
export function getAnnotationNamespaces(metadata: string, annotations: EdmxAnnotationsInfo): NamespaceAlias[] {
