...
- @sap-ux/odata-service-inquirer 3.2.20 → 3.2.21
...
- @sap-ux/launch-config 1.0.21 → 1.0.22
...
- @sap-ux/odata-service-inquirer 3.2.18 → 3.2.18
...
- @sap-ux/odata-service-inquirer 3.2.17 → 3.2.18
...
- @sap-ux/abap-deploy-config-writer 1.0.26 → 1.0.27
...
- @sap-ux/odata-service-inquirer 3.2.17 → 3.2.17
...
- @sap-ux/abap-deploy-config-writer 1.0.25 → 1.0.26
...
- @sap-ux/odata-service-inquirer 3.2.15 → 3.2.15
...
- @sap-ux/abap-deploy-config-writer 1.0.23 → 1.0.24
...
- @sap-ux/launch-config 1.0.19 → 1.0.20
...
- @sap-ux/launch-config 1.0.18 → 1.0.19
- @sap-ux/axios-extension 2.0.9 → 2.0.9
...
- @sap-ux/odata-service-inquirer 3.2.10 → 3.2.10
...
- @sap-ux/odata-service-inquirer 3.2.9 → 3.2.9
...
- @sap-ux/launch-config 1.0.17 → 1.0.18
...
- @sap-ux/odata-service-inquirer 3.2.4 → 3.2.5
...
- @sap-ux/launch-config 1.0.15 → 1.0.16
...
- @sap-ux/launch-config 1.0.14 → 1.0.15
...
- @sap-ux/launch-config 1.0.13 → 1.0.14
...
- @sap-ux/odata-service-inquirer 3.2.1 → 3.2.1
...
- @sap-ux/fiori-app-sub-generator 1.1.7 → 1.1.8
...
- @sap-ux/fiori-app-sub-generator 1.1.6 → 1.1.7
...
- @sap-ux/fiori-app-sub-generator 1.1.5 → 1.1.6
- @sap-ux/odata-service-inquirer 3.0.23 → 3.0.23
...
- @sap-ux/fiori-app-sub-generator 1.1.4 → 1.1.5
- @sap-ux/odata-service-inquirer 3.0.23 → 3.0.23
...
- @sap-ux/fiori-app-sub-generator 1.1.3 → 1.1.4
- @sap-ux/odata-service-inquirer 3.0.23 → 3.0.23
...
- @sap-ux/fiori-app-sub-generator 1.1.2 → 1.1.3
...
- @sap-ux/abap-deploy-config-writer 1.0.12 → 1.0.13
- @sap-ux/launch-config 1.0.10 → 1.0.11
...
- @sap-ux/abap-deploy-config-writer 1.0.11 → 1.0.12
...
- @sap-ux/launch-config 1.0.9 → 1.0.10
...
- @sap-ux/odata-service-inquirer 3.0.11 → 3.0.11
...
_Released: 2026-06-11T14:41:29Z_
...
- Updated dependencies [fff7490]
    ...
    - @sap-ux/abap-deploy-config-writer@1.0.5
...
- Updated dependencies [32609a7]
    - @sap-ux/abap-deploy-config-writer@1.0.0
...
- Updated dependencies [c12420a]
    ...
    - @sap-ux/abap-deploy-config-writer@0.4.4
...
- Updated dependencies [01b70ca]
    ...
    - @sap-ux/abap-deploy-config-writer@0.4.3
...
- Updated dependencies [21abda3]
    ...
    - @sap-ux/abap-deploy-config-writer@0.3.17
...
- Updated dependencies [678a08e]
    ...
    - @sap-ux/abap-deploy-config-writer@0.3.16
...
- Updated dependencies [1d60871]
    ...
    - @sap-ux/abap-deploy-config-writer@0.3.13
...
- Updated dependencies [cc4450c]
    ...
    - @sap-ux/odata-service-inquirer@2.20.10
...
- Updated dependencies [3291f6c]
    ...
    - @sap-ux/launch-config@0.10.82
    - @sap-ux/odata-service-inquirer@2.20.8
...
- c53a4ba: chore(repo-app-import-sub-generator): upgrade @sap-devx/yeoman-ui-types 1.22.0 → 1.23.0 (runtime dep); upgrade devDependencies (jest 30, i18next 25, @types/yeoman-generator 5.2.14)
...
- Updated dependencies [2e17a6b]
    ...
    - @sap-ux/odata-service-inquirer@2.20.5
...
- Updated dependencies [b66e827]
    - @sap-ux/project-access@1.35.17
    - @sap-ux/abap-deploy-config-writer@0.3.4
    ...
    - @sap-ux/launch-config@0.10.80
    - @sap-ux/odata-service-inquirer@2.20.4
...
- Updated dependencies [f384ace]
    ...
    - @sap-ux/abap-deploy-config-writer@0.3.2
    ...
    - @sap-ux/launch-config@0.10.78
    - @sap-ux/odata-service-inquirer@2.20.2
...
- Updated dependencies [a854433]
    ...
    - @sap-ux/abap-deploy-config-writer@0.2.93
...
- Updated dependencies [2d21925]
    ...
    - @sap-ux/abap-deploy-config-writer@0.2.91
...
- @sap-ux/abap-deploy-config-writer@0.2.85
...
- Updated dependencies [4af92b5]
    ...
    - @sap-ux/abap-deploy-config-writer@0.2.84
...
- Updated dependencies [ca2566b]
    ...
    - @sap-ux/abap-deploy-config-writer@0.2.83
    - @sap-ux/launch-config@0.10.71
...
- Updated dependencies [b96de78]
    ...
    - @sap-ux/abap-deploy-config-writer@0.2.81
...
- Updated dependencies [0ecc5f1]
    ...
    - @sap-ux/abap-deploy-config-writer@0.2.80
...
- @sap-ux/abap-deploy-config-writer@0.2.79
- @sap-ux/fiori-elements-writer@2.8.76
- @sap-ux/launch-config@0.10.67
...
- Updated dependencies [d588c26]
    ...
    - @sap-ux/axios-extension@1.25.15
    - @sap-ux/abap-deploy-config-writer@0.2.78
...
- Updated dependencies [d57cc47]
    - @sap-ux/odata-service-inquirer@2.18.5
    - @sap-ux/axios-extension@1.25.14
...
- @sap-ux/odata-service-inquirer@2.18.4
...
- Updated dependencies [d2b772d]
    ...
    - @sap-ux/launch-config@0.10.61
    - @sap-ux/odata-service-inquirer@2.17.3
...
- Updated dependencies [2fc459c]
    ...
    - @sap-ux/system-access@0.6.50
    - @sap-ux/abap-deploy-config-writer@0.2.69
...
- Updated dependencies [9a96150]
    ...
    - @sap-ux/system-access@0.6.49
    - @sap-ux/abap-deploy-config-writer@0.2.66
...
- Updated dependencies [83e3b70]
    ...
    - @sap-ux/abap-deploy-config-writer@0.2.65
...
- Updated dependencies [ad321ab]
    - @sap-ux/abap-deploy-config-writer@0.2.64
...
- Updated dependencies [ea7a16c]
    - @sap-ux/abap-deploy-config-writer@0.2.61
...
- Updated dependencies [be6ea11]
    ...
    - @sap-ux/odata-service-inquirer@2.14.19
    - @sap-ux/system-access@0.6.44
...
- @sap-ux/odata-service-inquirer@2.14.15
...
- Updated dependencies [a90c3e7]
    - @sap-ux/odata-service-inquirer@2.14.13
...
- Updated dependencies [43a86e2]
    - @sap-ux/odata-service-inquirer@2.14.11
...
- Updated dependencies [33d92e4]
    - @sap-ux/odata-service-inquirer@2.14.10
...
- Updated dependencies [f13d1c2]
    ...
    - @sap-ux/abap-deploy-config-writer@0.2.52
    - @sap-ux/axios-extension@1.25.6
...
- Updated dependencies [e111d0d]
    ...
    - @sap-ux/system-access@0.6.40
    - @sap-ux/abap-deploy-config-writer@0.2.51
...
- Updated dependencies [2204ad3]
    ...
    - @sap-ux/abap-deploy-config-writer@0.2.50
...
- Updated dependencies [4e0f204]
    ...
    - @sap-ux/abap-deploy-config-writer@0.2.49
...
- Updated dependencies [4ecfbe2]
    - @sap-ux/abap-deploy-config-writer@0.2.43
...
- Updated dependencies [07725fe]
    ...
    - @sap-ux/abap-deploy-config-writer@0.2.36
    - @sap-ux/axios-extension@1.24.3
    - @sap-ux/fiori-generator-shared@0.13.36
    - @sap-ux/launch-config@0.10.38
    - @sap-ux/odata-service-inquirer@2.11.12
...
_Released: 2025-11-11T09:02:15Z_
...
_Released: 2025-07-24T07:43:22Z_
...
_Released: 2025-07-10T10:15:42Z_
...
_Released: 2025-06-26T09:58:33Z_

### Patch Changes

- Updated dependencies [bac9dbc]
    - @sap-ux/launch-config@0.10.7
...
_Released: 2025-06-24T15:00:12Z_
...
_Released: 2025-06-19T14:29:25Z_
...
_Released: 2025-06-04T16:17:18Z_
...
_Released: 2025-05-30T16:18:42Z_
...
_Released: 2025-04-29T12:46:24Z_
...
_Released: 2025-04-25T09:58:38Z_
...
_Released: 2025-04-18T12:20:00Z_
...
_Released: 2025-04-18T10:46:28Z_
...
_Released: 2025-04-18T09:33:54Z_
...
_Released: 2025-04-17T15:32:49Z_
...
_Released: 2025-04-16T15:25:51Z_
...
_Released: 2025-04-15T22:47:02Z_
