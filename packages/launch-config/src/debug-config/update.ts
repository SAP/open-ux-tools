...
import type { UpdateWorkspaceFolderOptions, WorkspaceHandlerInfo, DebugOptions, LaunchJSON } from '../types';
import { join, basename } from 'path';
import { handleWorkspaceConfig } from './workspaceManager';
import { configureLaunchJsonFile } from './config';
