...
export const MANIFEST_VERSIONS_REGEX =
    /(?<="minUI5Version": "|"version": "|"_version": ")([0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3})/; // General version regex - only use if you explicitly dont want to test ui5 versions
...
export const YAML_VERSION_REGEX = /(?<=version: )([0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3})/; // Match ui5 version as it appears in the ui5-local.yaml file
...
export const PACKAGE_JSON_UI5_TYPES_VERSION = /(?<=@sapui5\/types: )([0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3})/; // Match the UI5 types version in the package.json
