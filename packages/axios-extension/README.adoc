...
Supported ADT services are implemented in [src/abap/adt-catalog/services](https://github.com/SAP/open-ux-tools/tree/main/packages/axios-extension/src/abap/adt-catalog/services).
