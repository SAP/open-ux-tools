...
/**
 * Initialization Code and shared classes of library test.ui5.typescript.library1.
 */
...
Lib.init({
	...
	types: [
		"test.ui5.typescript.library1.ExampleColor"
	],
	interfaces: [],
	controls: [
		"test.ui5.typescript.library1.Example"
	],
	elements: [],
...
const thisLib : {[key: string]: unknown} = ObjectPath.get("test.ui5.typescript.library1") as {[key: string]: unknown};
