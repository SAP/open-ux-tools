...
import cardsConfigRes from './translations/cards-config.json' with { type: 'json' };

export const SMART_LINKS_NS = 'app-config-writer:smartLinksConfig';
export const NAV_CONFIG_NS = 'app-config-writer:navConfig';
export const CARDS_CONFIG_NS = 'app-config-writer:cardsConfig';
    ...
    await i18n.init({
        resources: {
            en: {
                ...
                [CARDS_CONFIG_NS]: cardsConfigRes
            }
        },
        lng: 'en',
        fallbackLng: 'en',
        defaultNS: SMART_LINKS_NS, // Default since first to add translations
        ns: [SMART_LINKS_NS, NAV_CONFIG_NS, CARDS_CONFIG_NS],
