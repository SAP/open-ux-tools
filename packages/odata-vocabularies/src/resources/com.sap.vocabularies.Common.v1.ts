...
export default {
    ...
    'com.sap.vocabularies.Common.v1': {
        ...
        FieldControlType: {
            ...
            Hidden: 0,
            'Hidden@Org.OData.Core.V1.Description': 'Deprecated synonymn for Inapplicable, do not use',
        ...
        QualifiedName: {
            $Kind: 'TypeDefinition',
            $UnderlyingType: 'Edm.String',
            '@Org.OData.Core.V1.Description': 'The QualifiedName of an OData construct in scope'
        },
        ActionOverload: {
            $Kind: 'TypeDefinition',
            $UnderlyingType: 'Edm.String',
            '@Org.OData.Core.V1.Description': 'The qualified name of an action with an optional overload',
            '@Org.OData.Core.V1.LongDescription':
