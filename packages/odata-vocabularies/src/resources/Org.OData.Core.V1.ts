        ...
        Example: {
            ...
            '@Org.OData.Core.V1.Example': {
                ...
                '@Org.OData.Core.V1.Example#primitive': {
                    '@odata.type': '#Org.OData.Core.V1.PrimitiveExampleValue',
                    Description: 'Primitive example value',
                    Value: 'Hello World'
                },
                '@Org.OData.Core.V1.Example#complex': {
                    '@odata.type': '#Org.OData.Core.V1.ComplexExampleValue',
                ...
                '@Org.OData.Core.V1.Example#entity': {
                    '@odata.type': '#Org.OData.Core.V1.EntityExampleValue',
                ...
                '@Org.OData.Core.V1.Example#external': {
                    '@odata.type': '#Org.OData.Core.V1.ExternalExampleValue',
