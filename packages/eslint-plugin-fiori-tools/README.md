...
|:-----:|------|-------------|:-----------:|:-----------------------:|
| new   | [sap-condensed-table-layout](docs/rules/sap-condensed-table-layout.md) | Requires `condensedTableLayout` to be enabled when using Grid Table, Analytical Table, or Tree Table | | ✅ |
