...
|:---------:|------|-------------|:-----------:|:-----------------------:|
|  new      | [sap-no-comma-in-section-title](docs/rules/sap-no-comma-in-section-title.md) | Ensures that section and subsection titles in SAP Fiori Elements object pages do not contain commas. | | ✅ |
