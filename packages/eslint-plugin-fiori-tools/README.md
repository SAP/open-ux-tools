...
|:---------:|------|-------------|:-----------:|:-----------------------:|
|  new      | [sap-cloud-dev-adaptation-status](docs/rules/sap-cloud-dev-adaptation-status.md) | Ensures that `cloudDevAdaptationStatus` is defined in the `sap.fiori` section of the manifest.json. | | ✅ |
