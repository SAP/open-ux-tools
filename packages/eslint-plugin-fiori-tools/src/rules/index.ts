...
import descriptionColumnLabel from './sap-description-column-label.js';
...
import groupingSupportedTableTypesOnly from './sap-grouping-supported-table-types-only.js';
...
export const rules: Record<string, Rule.RuleModule | FioriRuleDefinition | FioriXMLRuleDefinition> = {
    ...
    [GROUPING_SUPPORTED_TABLE_TYPES_ONLY]: groupingSupportedTableTypesOnly
};
