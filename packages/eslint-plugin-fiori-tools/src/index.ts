...
export const configs = {
    ...
    get recommended(): Linter.Config[] {
        ...
        return [
            ...
            ...testConfig,
            {
                files: ['**/manifest.json', '**/*.xml'],
                language: '@sap-ux/eslint-plugin-fiori-tools/fiori',
                plugins: {
                    '@sap-ux/eslint-plugin-fiori-tools': plugin
                },
                rules: {
                    '@sap-ux/eslint-plugin-fiori-tools/require-fiori-annotations': 'warn',
                    ...
                    '@sap-ux/eslint-plugin-fiori-tools/no-unresolved-annotation-paths': 'warn'
                }
            }
        ];
    },
