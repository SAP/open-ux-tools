...
describe('readHashFromFlpSandbox()', () => {
    ...
    test('extracts the first application key from sap-ushell-config', () => {
        ...
        expect(readHashFromFlpSandbox('test/flpSandbox.html', basePath, fs)).toBe('fincashbankmanage-tile');
    ...
    test('extracts key when multiple applications exist', () => {
        ...
        expect(readHashFromFlpSandbox('test/flpSandbox.html', basePath, fs)).toBe('first-app-tile');
    });
    ...
    test('returns undefined when no applications block is found', () => {
        ...
        expect(readHashFromFlpSandbox('test/flpSandbox.html', basePath, fs)).toBeUndefined();
    });
