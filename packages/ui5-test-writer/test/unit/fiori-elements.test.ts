...
const actualXmlMetadataUtils = await import('../../src/utils/xmlMetadataUtils.js');
jest.unstable_mockModule('../../src/utils/xmlMetadataUtils.js', () => ({
    ...actualXmlMetadataUtils,
...
describe('ui5-test-writer', () => {
    ...
    beforeEach(() => {
        ...
        // Default to delegating to the real implementation so callers passing a metadata XML override
        // exercise the same path as production. Specific tests can replace this with `mockResolvedValueOnce(...)`.
        loadServiceMetadataMock.mockImplementation(actualXmlMetadataUtils.loadServiceMetadata);
    });
