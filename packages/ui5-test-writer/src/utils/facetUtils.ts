...
import type { CollectionFacet, FacetTypes } from '@sap-ux/vocabularies-types/vocabularies/UI.js';

const UI_COLLECTION_FACET_TYPE = 'com.sap.vocabularies.UI.v1.CollectionFacet';
...
function findFacet(facets: FacetTypes[], identifier: FacetIdentifier): FacetTypes | undefined {
    for (const facet of facets) {
        ...
        if (facet.$Type === UI_COLLECTION_FACET_TYPE) {
