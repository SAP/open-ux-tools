...
export type ModelOutputFormat = 'embedding-classifier-v2' | 'embedding-classifier-v3' | 'row-object-v1';
...
function component(value: unknown): ModelComponentManifest {
    ...
    const outputFormat = oneOf(
        ...
        ['embedding-classifier-v2', 'embedding-classifier-v3', 'row-object-v1'] as const,
        'model runtime output format'
    );
    if (kind === 'classifier' ? outputFormat === 'row-object-v1' : outputFormat !== 'row-object-v1') {
