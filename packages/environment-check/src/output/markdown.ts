 ...
 * @param isDestinationsChecked - have the destinations been checked
 * @returns - markdown report
 */
export function convertResultsToMarkdown(results: EnvironmentCheckResult, isDestinationsChecked = false): string {
