		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#testprojectfflistdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testprojectfflistdetail-display": {
								"semanticObject": "testprojectfflistdetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=testprojectfflistdetail",
									"url": sap.ui.require.toUrl("testprojectfflistdetail")
								}
							}
						}
					}
