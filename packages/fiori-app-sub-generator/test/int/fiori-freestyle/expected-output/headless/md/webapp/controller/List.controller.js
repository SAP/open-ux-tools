sap.ui.define([
    ...
    return BaseController.extend("appnamespace.md.controller.List", {
        ...
        onInit : function () {
            ...
            this._oGroupFunctions = {
                objectNum: function(oContext) {
                    var iNumber = oContext.getProperty('objectNum'),
                        key, text;
                    if (iNumber <= 20) {
                        key = "LE20";
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("pageId", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "appnamespace.md.view.ViewSettingsDialog",
                    controller: this
        ...
        onConfirmViewSettingsDialog: function (oEvent) {
            ...
            aFilterItems.forEach(function (oItem) {
                switch (oItem.getKey()) {
                    case "Filter1" :
                        aFilters.push(new Filter("objectNum", FilterOperator.LE, 100));
                        break;
                    case "Filter2" :
                        aFilters.push(new Filter("objectNum", FilterOperator.GT, 100));
                        break;
                    default :
                        break;
                }
