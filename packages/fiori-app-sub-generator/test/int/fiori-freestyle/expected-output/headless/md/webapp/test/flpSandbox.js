		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#appnamespacemd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appnamespacemd-display": {
								"semanticObject": "appnamespacemd",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=appnamespace.md",
									"url": sap.ui.require.toUrl("appnamespace/md")
								}
							}
						}
					}
