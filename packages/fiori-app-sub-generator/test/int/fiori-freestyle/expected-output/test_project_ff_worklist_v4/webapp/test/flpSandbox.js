		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#testprojectffworklistv4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testprojectffworklistv4-display": {
								"semanticObject": "testprojectffworklistv4",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=testprojectffworklistv4",
									"url": sap.ui.require.toUrl("testprojectffworklistv4")
								}
							}
						}
					}
