		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#testAppNamespacetestprojectffworklistv2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testAppNamespacetestprojectffworklistv2-display": {
								"semanticObject": "testAppNamespacetestprojectffworklistv2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=testAppNamespace.testprojectffworklistv2",
									"url": sap.ui.require.toUrl("testAppNamespace/testprojectffworklistv2")
								}
							}
						}
					}
