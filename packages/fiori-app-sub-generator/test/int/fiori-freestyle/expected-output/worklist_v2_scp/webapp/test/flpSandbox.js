		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Worklist v2 SCP Test App",
									"targetURL": "#testAppNamespaceworklistv2scp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testAppNamespaceworklistv2scp-display": {
								"semanticObject": "testAppNamespaceworklistv2scp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=testAppNamespace.worklistv2scp",
									"url": sap.ui.require.toUrl("testAppNamespace/worklistv2scp")
								}
							}
						}
					}
