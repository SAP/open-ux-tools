...
sap.ui.require(
  [
    ...
    "testNameSpace/lropv4/test/integration/TravelListJourney",
    "testNameSpace/lropv4/test/integration/TravelObjectPageJourney",
    "testNameSpace/lropv4/test/integration/BookingObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
