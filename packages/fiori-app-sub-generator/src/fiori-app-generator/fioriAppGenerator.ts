...
import { writeInfoFiles, writeAPIHubKeyFiles } from './writing';
...
export class FioriAppGenerator extends Generator {
    ...
    async writing(): Promise<void> {
        try {
            ...
            await writeInfoFiles(this.state, generatorName, this.generatorVersion, destRoot, this.fs, readMeUpdated);
        } catch (error) {
