...
const adpTools = [
    ...
    },
    {
        ...
        description: `Internal step runner for the **sap-fiori-adp-controller-extension** skill. **Do not call this tool standalone.**
        ...
        Always go through the **sap-fiori-adp-controller-extension** skill in the SAP Fiori MCP server.
